...
export async function generateMetadata({
  ...
  return { ...pageMetadata({ locale, path: "/politique-de-confidentialite", title: "Politique de confidentialité" }), robots: { index: false, follow: true } };
}
  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-6">
      <div className="text-center max-w-lg">
        ...
        <h1 className="font-display text-3xl mt-2">Politique de confidentialité</h1>
      </div>
    </main>
  );
}
