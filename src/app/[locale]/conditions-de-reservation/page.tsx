...
export async function generateMetadata({
  ...
  return { ...pageMetadata({ locale, path: "/conditions-de-reservation", title: "Conditions de réservation" }), robots: { index: false, follow: true } };
}
  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-6">
      <div className="text-center max-w-lg">
        ...
        <h1 className="font-display text-3xl mt-2">Conditions de réservation</h1>
      </div>
    </main>
  );
}
