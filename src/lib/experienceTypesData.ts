...
export const TRAVELER_TYPE_PAGES: TravelerTypePage[] = [
  {
    ...
    linkCardGroups: [
      {
        heading: { fr: "Qui voyage ?", en: "Who's travelling?", es: "¿Quién viaja?" },
        cards: [
          {
            key: "toddlers",
            image: `${R2}/experiences/what-family.jpg`,
            title: { fr: "Voyager avec de tout-petits", en: "Travelling with toddlers", es: "Viajar con niños pequeños" },
            desc: { fr: "Vols courts, rythme doux, hébergements calmes.", en: "Short flights, a gentle pace, calm accommodation.", es: "Vuelos cortos, ritmo suave, alojamientos tranquilos." },
            href: "/experience-types/family-holidays/toddlers",
          },
          {
            key: "teens",
            image: `${R2}/destinations/espagne-hero.jpg`,
            title: { fr: "Voyager avec des ados", en: "Travelling with teens", es: "Viajar con adolescentes" },
            desc: { fr: "De l'action, de la liberté encadrée, de vraies sensations.", en: "Real action, supervised freedom, real sensation.", es: "Acción real, libertad supervisada, sensaciones auténticas." },
            href: "/experience-types/family-holidays/teens",
          },
          {
            key: "adults",
            image: `${R2}/destinations/italie.jpg`,
            title: { fr: "Enfants devenus grands", en: "Adult children", es: "Hijos ya adultos" },
            desc: { fr: "Moins de logistique, plus de moments partagés en adultes.", en: "Less logistics, more moments shared as adults.", es: "Menos logística, más momentos compartidos como adultos." },
            href: "/experience-types/family-holidays/adults",
          },
          {
            key: "multi-generational",
            image: `${R2}/destinations/france-hero.jpg`,
            title: { fr: "Voyage multi-générationnel", en: "Multi-generational travel", es: "Viaje multigeneracional" },
            desc: { fr: "Trois générations, trois rythmes, un seul voyage.", en: "Three generations, three paces, one trip.", es: "Tres generaciones, tres ritmos, un solo viaje." },
            href: "/experience-types/family-holidays/multi-generational",
          },
        ],
      },
      {
        heading: { fr: "Quand partir ?", en: "When to travel?", es: "¿Cuándo viajar?" },
        cards: [
          {
            key: "spring",
            image: `${R2}/destinations/portugal-hero.jpg`,
            title: { fr: "Au printemps", en: "In spring", es: "En primavera" },
            desc: { fr: "Climat doux, sites moins bondés.", en: "Mild weather, thinner crowds.", es: "Clima suave, menos aglomeraciones." },
            href: "/experience-types/family-holidays/spring",
          },
          {
            key: "summer",
            image: `${R2}/destinations/maldives.jpg`,
            title: { fr: "En été", en: "In summer", es: "En verano" },
            desc: { fr: "Les grandes vacances, entre plages et fraîcheur.", en: "The long summer break, between beaches and cooler escapes.", es: "Las vacaciones de verano, entre playas y destinos más frescos." },
            href: "/experience-types/family-holidays/summer",
          },
          {
            key: "autumn",
            image: `${R2}/destinations/croatie-hero.jpg`,
            title: { fr: "En automne", en: "In autumn", es: "En otoño" },
            desc: { fr: "Tarifs plus doux, sites vidés de la foule d'été.", en: "Gentler prices, sites emptied of summer crowds.", es: "Precios más suaves, lugares vaciados de la multitud del verano." },
            href: "/experience-types/family-holidays/autumn",
          },
          {
            key: "winter",
            image: `${R2}/destinations/suisse-hero.jpg`,
            title: { fr: "En hiver", en: "In winter", es: "En invierno" },
            desc: { fr: "Neige, aurores boréales, ou un safari sans la chaleur.", en: "Snow, northern lights, or a safari without the heat.", es: "Nieve, auroras boreales, o un safari sin el calor." },
            href: "/experience-types/family-holidays/winter",
          },
        ],
      },
      {
        heading: { fr: "Quel type de voyage ?", en: "What type of trip?", es: "¿Qué tipo de viaje?" },
        cards: [
          {
            key: "adventure",
            image: `${R2}/experiences/what-adventure.jpg`,
            title: { fr: "Aventure", en: "Adventure", es: "Aventura" },
            desc: { fr: "Quad, randonnée, nuit sous tente.", en: "Quad biking, hiking, a night under canvas.", es: "Quad, senderismo, una noche bajo la tienda." },
            href: "/experience-types/family-holidays/adventure",
          },
          {
            key: "wildlife",
            image: `${R2}/destinations/kenya.jpg`,
            title: { fr: "Faune sauvage", en: "Wildlife", es: "Fauna salvaje" },
            desc: { fr: "Safari, baleines, aurores boréales.", en: "Safari, whales, northern lights.", es: "Safari, ballenas, auroras boreales." },
            href: "/experience-types/family-holidays/wildlife",
          },
          {
            key: "cultural",
            image: `${R2}/experiences/what-culture.jpg`,
            title: { fr: "Immersion culturelle", en: "Cultural immersion", es: "Inmersión cultural" },
            desc: { fr: "Cours de cuisine, artisans, marchés.", en: "Cooking classes, artisans, markets.", es: "Clases de cocina, artesanos, mercados." },
            href: "/experience-types/family-holidays/cultural",
          },
          {
            key: "beach",
            image: `${R2}/experiences/what-relax.jpg`,
            title: { fr: "Plage et détente", en: "Beach & relaxation", es: "Playa y descanso" },
            desc: { fr: "Ne rien faire, ensemble, au bord de l'eau.", en: "Doing nothing, together, by the water.", es: "No hacer nada, juntos, junto al agua." },
            href: "/experience-types/family-holidays/beach",
          },
          {
            key: "bucket-list",
            image: `${R2}/destinations/islande.jpg`,
            title: { fr: "Le grand voyage à cocher", en: "The bucket-list trip", es: "El gran viaje pendiente" },
            desc: { fr: "Celui qu'on repousse depuis des années.", en: "The one always pushed to someday.", es: "El que se posterga desde hace años." },
            href: "/experience-types/family-holidays/bucket-list",
          },
          {
            key: "graduation",
            image: `${R2}/destinations/turquie-hero.jpg`,
            title: { fr: "Fin d'études", en: "Graduation trip", es: "Fin de curso" },
            desc: { fr: "Assez de liberté pour se sentir grand.", en: "Enough freedom to feel grown-up.", es: "Suficiente libertad para sentirse mayor." },
            href: "/experience-types/family-holidays/graduation",
          },
          {
            key: "mother-daughter",
            image: `${R2}/destinations/grece-hero.jpg`,
            title: { fr: "Mère-fille", en: "Mother-daughter", es: "Madre e hija" },
            desc: { fr: "Un temps rien qu'à deux.", en: "Time just for the two of you.", es: "Tiempo solo para las dos." },
            href: "/experience-types/family-holidays/mother-daughter",
          },
          {
            key: "father-son",
            image: `${R2}/destinations/norvege-hero.jpg`,
            title: { fr: "Père-fils", en: "Father-son", es: "Padre e hijo" },
            desc: { fr: "De l'aventure, et le temps de vraiment se parler.", en: "Adventure, and real time to talk.", es: "Aventura, y tiempo real para hablar." },
            href: "/experience-types/family-holidays/father-son",
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    linkCardGroups: [
      {
        heading: { fr: "Quel genre de lune de miel ?", en: "What kind of honeymoon?", es: "¿Qué tipo de luna de miel?" },
        cards: [
          {
            key: "safari",
            image: `${R2}/destinations/kenya.jpg`,
            title: { fr: "Lune de miel safari", en: "Safari honeymoon", es: "Luna de miel safari" },
            desc: { fr: "Un lever de soleil sur la savane, rien que pour vous deux.", en: "A sunrise over the savannah, just for the two of you.", es: "Un amanecer sobre la sabana, solo para ustedes dos." },
            href: "/excursions?travelers=honeymoon&theme=adventure",
          },
          {
            key: "city",
            image: `${R2}/destinations/espagne-hero.jpg`,
            title: { fr: "Lune de miel citadine", en: "City honeymoon", es: "Luna de miel urbana" },
            desc: { fr: "Musées, tables réputées, une ville à découvrir à deux.", en: "Museums, celebrated tables, a city to discover together.", es: "Museos, mesas reconocidas, una ciudad para descubrir juntos." },
            href: "/excursions?travelers=honeymoon&theme=culture",
          },
          {
            key: "beach",
            image: `${R2}/destinations/maldives.jpg`,
            title: { fr: "Lune de miel plage", en: "Beach honeymoon", es: "Luna de miel de playa" },
            desc: { fr: "Une villa sur pilotis et rien d'autre au programme.", en: "An overwater villa and nothing else on the agenda.", es: "Una villa sobre el agua y nada más en el programa." },
            href: "/excursions?travelers=honeymoon&theme=relax",
          },
          {
            key: "unusual",
            image: `${R2}/destinations/islande.jpg`,
            title: { fr: "Lune de miel hors des sentiers battus", en: "Unusual honeymoon", es: "Luna de miel poco convencional" },
            desc: { fr: "Aurores boréales, glaciers, un décor que personne n'oublie.", en: "Northern lights, glaciers, a backdrop nobody forgets.", es: "Auroras boreales, glaciares, un escenario que nadie olvida." },
          ...
          },
          {
            key: "mini-moon",
            image: `${R2}/destinations/portugal-hero.jpg`,
            title: { fr: "Mini-lune de miel", en: "Mini-moon", es: "Mini luna de miel" },
            desc: { fr: "Peu de temps devant vous ? Un format court, tout aussi mémorable.", en: "Short on time? A shorter format, just as memorable.", es: "¿Poco tiempo? Un formato más corto, igual de memorable." },
            href: "/excursions?travelers=honeymoon",
          },
        ],
      },
