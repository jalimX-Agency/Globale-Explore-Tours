  ...
  return (
    <section className="bg-[var(--brand-sand)] py-16 sm:py-20">
      <div className="mx-auto max-w-3xl px-6 text-center lg:px-10">
        <p className="label-eyebrow text-neutral-600">{t("approach.tab")}</p>
        ...
        <motion.h2
          ...
          className="font-display mt-4 text-3xl font-normal leading-tight tracking-wide text-neutral-800 sm:text-4xl lg:text-[45px] lg:leading-[1.15]"
        ...
        >
          <p>{t("approach.body1")}</p>
          <p>{t("approach.body2")}</p>
        </motion.div>
