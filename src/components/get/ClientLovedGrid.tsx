        ...
        {blocks.map((block, i) => {
          ...
          return (
            <div key={i} className="flex flex-col">
              ...
              <p className="font-body mt-1.5 flex-1 text-sm text-neutral-600">{description}</p>
              <div className="mt-4 flex items-center gap-4">
                <LocaleLink href={block.ctaHref || "/reserver"} className="label-eyebrow text-neutral-900 hover:opacity-60">
                  {ctaLabel}
                </LocaleLink>
